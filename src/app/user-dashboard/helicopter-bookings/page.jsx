      ...
      <div className="p-6 lg:p-8">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            ...
            <h1 className="text-3xl font-bold text-gray-900">My Helicopter Bookings</h1>
          </div>
        ...
        {bookings.length === 0 ? (
          <div className="bg-white rounded-2xl shadow-lg border border-gray-200 p-12 text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-900 mb-2">No Helicopter Bookings Found</h3>
            <p className="text-gray-600 mb-6">You haven't made any helicopter bookings yet. Book your first helicopter ride today!</p>
            <button 
