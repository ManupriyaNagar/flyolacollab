...
export default function OperationsDashboardLayout({ children }) {
  ...
  // Check if user has role 8 (Operations Admin)
  useEffect(() => {
  ...
  return (
    <RouteGuard>
      <div className="flex min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100">
        ...
        >
            ...
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-400">Madhya Pradesh Tourism</p>
                </div>
              </div>
              <button
          ...
          <nav className="flex-1 p-4 space-y-2 overflow-y-auto">
            ...
            <div className="mb-6">
              ...
              >
                <FaHome className={`text-lg ${isActive("/operations-dashboard") && normalizedPathname === "/operations-dashboard" ? "text-white" : "text-blue-400"}`} />
            ...
            <div className="mb-6">
              ...
              <div className="space-y-1">
                ...
                >
                  <FaPlane className={`text-lg rotate-45 ${isActive("/operations-dashboard/helicopter-bookings") ? "text-white" : "text-red-400"}`} />
        ...
        {/* Main Content */}
        <main className="flex-1 relative md:ml-80 overflow-x-hidden">
          {/* Header */}
          ...
          {/* Content Area */}
          <div className="p-6 min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-100 overflow-x-hidden">
            <div className="w-full max-w-full overflow-x-hidden">
              <div className="bg-white/70 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-8 min-h-[600px] overflow-x-hidden">
                {children}
              </div>
            </div>
          </div>
