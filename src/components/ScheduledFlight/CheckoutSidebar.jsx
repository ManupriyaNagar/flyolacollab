...
export default function CheckoutSidebar({
  ...
  return (
    <div className="w-full max-w-md mx-auto space-y-8 py-2">
      {/* OFFERS SECTION */}
      <div className="bg-white rounded-[32px] shadow-lg border border-gray-100 overflow-hidden">
        <div className="p-8">
          <h2 className="text-3xl font-bold text-gray-900 mb-6 tracking-tight">Offers For You</h2>
          ...
          <div className="relative mb-8">
            <input
              ...
              className="w-full border-2 border-gray-200 rounded-2xl px-5 py-4 text-gray-800 text-lg focus:outline-none focus:border-blue-400 placeholder:text-gray-400 transition-all font-medium"
            />
          </div>
              ...
              >
                ...
                <div className="flex-1">
                  <div className="flex justify-between items-center mb-1 gap-2">
                    <span className="text-xl font-bold text-gray-900 tracking-tight">{offer.title}</span>
                    <span className="text-xl font-bold text-gray-900 tracking-tight whitespace-nowrap">{offer.discount}</span>
                  </div>
                  ...
                  <button className="text-[14px] font-bold text-gray-900 underline mt-2 hover:text-blue-600 transition-colors">
                    Know More
                  </button>
                </div>
              </div>
        ...
        <div className="border-t border-gray-100 p-6 flex justify-center bg-gray-50/30">
          <button className="text-xl font-bold text-gray-900 tracking-tight hover:text-blue-600 transition-colors">
            View All Offers
          </button>
        </div>
      </div>
      ...
      <div className="bg-white rounded-[32px] shadow-lg border border-gray-100 p-8">
        <div className="flex justify-between items-start mb-6">
          <h3 className="text-2xl font-bold text-gray-900 tracking-tight">Active Filters Summary</h3>
        ...
        <div className="flex items-center gap-1 mb-6">
          <div className="flex-1 bg-[#EFF6FF] rounded-full py-4 px-6 flex items-center justify-center gap-2 border border-blue-50/50">
            <PlaneTakeoff className="w-6 h-6 text-gray-900" />
            <span className="text-lg font-bold text-gray-900 tracking-tight truncate">{departure}({departureCode})</span>
          </div>
          ...
          <div className="flex-1 bg-[#EFF6FF] rounded-full py-4 px-6 flex items-center justify-center gap-2 border border-blue-50/50">
            ...
            <span className="text-lg font-bold text-gray-900 tracking-tight truncate">{arrival}({arrivalCode})</span>
          </div>
        </div>
      ...
      <div className="px-2 space-y-12 pb-10">
        <p className="text-[20px] text-gray-900 leading-[1.6] font-semibold tracking-tight">
        ...
        <div className="space-y-6">
          <h4 className="text-2xl font-bold text-gray-400 tracking-tighter uppercase opacity-80">100% Safe Payment Process</h4>
          ...
          <div className="flex items-center gap-8 py-2 overflow-hidden">
            ...
            <div className="flex flex-wrap items-center gap-8">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xl font-bold text-gray-600 tracking-tighter">SafeKey®</span>
              </div>

              <div className="flex items-center gap-3 pl-6 border-l-2 border-gray-100">
                <span className="text-2xl font-extrabold text-blue-800 italic tracking-tighter">VISA</span>
                <div className="flex flex-col leading-none">
                  <span className="text-[10px] font-bold text-gray-600 uppercase">Verified by</span>
              ...
              <div className="flex items-center gap-2 pl-6 border-l-2 border-gray-100">
                ...
                <div className="flex flex-col leading-none ml-2">
                  ...
                  <span className="text-[10px] font-bold text-gray-500">SecureCode.</span>
                </div>
              </div>
            </div>
          </div>
